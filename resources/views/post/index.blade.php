                ...
                <tbody>
                    @foreach ($posts as $post)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <span class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">{{ $post->category->name }}</span>
                            </td>
                            <td class="px-6 py-4">
                                <img src="{{ Storage::url($post->image) }}" alt="{{ $post->title }}" class="w-20 h-20">
                            </td>
                            <td class="px-6 py-4">
                                {{ $post->description }}
                            </td>
                            <td class="flex space-x-6 px-6 py-4 items-center">
